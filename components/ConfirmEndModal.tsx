...
const ConfirmEndModal: React.FC<ConfirmEndModalProps> = ({ isOpen, onClose, onConfirm }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 animate-fade-in" onClick={onClose}>
      <div className="bg-gray-800 rounded-lg p-8 shadow-2xl max-w-md w-full border border-gray-700" onClick={(e) => e.stopPropagation()}>
        <h2 className="text-2xl font-bold mb-4 text-center text-yellow-400">¿Terminar Sesión?</h2>
        <p className="text-gray-400 mb-6 text-center">
          Estás a punto de terminar la sesión antes de completarla. Tu progreso no se guardará.
          <br/>
